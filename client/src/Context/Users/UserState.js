...
const UserState = (props) => {
  ...
  const createTeam = (users) => {
    const { id, first_name, last_name, domain, _id,avatar } = users;
    ...
    setSelectedUsers([...selectedUsers, { id: id, first_name: first_name, last_name: last_name, domain: domain, avatar }]);
  }
